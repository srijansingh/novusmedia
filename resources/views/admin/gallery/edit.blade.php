                ...
                <form action="/gallery/{{$gallery->id}}" method="post" enctype="multipart/form-data">
                    <div class="column">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter photo title" value="{{$gallery->name}}">
                        </div>
                      {{--  <div class="col-lg-4 form-group">
                            <label>Photos</label>
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <select name="membername" class="form-control">
                                <option selected value="{{$gallery->membername}}">{{$gallery->membername}}</option>
                                @foreach($member as $members)
                                    <option value="{{$members->membername}}">{{$members->membername}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-lg-4 form-group">
                            ...
                            <select name="albumname" class="form-control">
                                <option selected value="{{$gallery->albumname}}">{{$gallery->albumname}}</option>
                                @foreach($album as $albums)
                                    <option value="{{$albums->albumname}}">{{$albums->albumname}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class=" form-group">
                        <input type="submit" name="pic" class="btn btn-primary" value="Update Now">
                    </div>
                </form>
            </div>
