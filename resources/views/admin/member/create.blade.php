                ...
                <form action="/member" method="post" enctype="multipart/form-data">
                    <div class="column">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" name="membertag" class="form-control" placeholder="Enter Member Tag">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>Member Description</label>

                            <textarea name="aboutmember" class="form-control" cols="30" rows="5" style="resize:none" placeholder="About members"></textarea>
                        </div>
                    ...
                    <div class=" form-group">
                        <input type="submit" name="pic" class="btn btn-primary" value="Insert Member" style="">
                    </div>
                </form>
