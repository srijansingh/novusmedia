    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Team Novus Media</h1>
                @if(count($errors)>0)
                ...
                <form action="/member/{{$member->id}}" method="post" enctype="multipart/form-data">
                    <div class="column">
                        ...
                        <div class="col-lg-4 form-group">
                            ...
                            <input type="text" name="membername" class="form-control" placeholder="Enter Member Name" value="{{$member->membername}}">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>Member Profile Tag</label>
                            <input type="text" name="membertag" class="form-control" placeholder="Enter Member Tag" value="{{$member->membertag}}">
                        </div>
                        <div class="col-lg-4 form-group">
                            <label>Member Description</label>

                            <textarea name="aboutmember" class="form-control" cols="30" rows="5" style="resize:none" placeholder="About members">{{$member->aboutmember}}</textarea>
                        </div>


                       {{-- <div class="col-lg-4 form-group">
                            <label>Member Profile Picture</label>
                            <input type="file" name="profilepic" class="form-control" value="{{$member->profilepic}}">
                        </div>--}}
